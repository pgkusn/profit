<template>
    <section class="review mt-12 xl:mt-32 pt-16 pb-8 xl:py-0 bg-gray-100">
        <div class="container relative xl:flex xl:justify-between">
            <div class="review__decoration absolute"></div>
            <div class="relative xl:pt-28" data-aos="fade-right">
                <h1 class="text-5xl text-center xl:text-left mb-8 xl:mb-20 uppercase">What our <strong>clients say</strong></h1>
                <div class="text-slider xl:self-center">
                    <swiper
                        ...
                        <swiper-slide v-for="item in data" :key="item.img">
                            <span class="linearicons-quote-close text-2xl xl:text-4xl text-red"></span>
                            <p class="text-lg xl:text-2xl italic text-gray-500 pl-8">{{ item.say }}</p>
                            <span class="linearicons-quote-open text-2xl xl:text-4xl text-red block text-right xl:mt-16 xl:pr-28"></span>
                            <p class="review__name pl-8 text-lg flex items-center">{{ item.name }}</p>
                        </swiper-slide>
                    </swiper>
                </div>
                <button class="btn px-4 my-14 xl:mb-0">leave your Review</button>
            </div>
                ...
                <swiper
                    ...
                    <swiper-slide
                        ...
                        <div class="bg-white p-1.5 shadow-xl group">
                            <div class="photo-slider__slide--img bg-cover transition duration-300 transform group-hover:scale-95" :style="{ 'background-image': `url(${item.img})` }"></div>
                            <p class="text-lg text-center pt-4 pb-2 transition duration-300 transform group-hover:-translate-x-6">- {{ item.lbs }} lbs</p>
                        </div>
                    </swiper-slide>

                    <div class="mx-auto mt-14 h-6 flex justify-center" v-show="!screens.xl">
