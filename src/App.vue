<template>
    <HeaderBlock ref="headerComponent" :section-pos="sectionPos" />

    <div id="home" class="hero relative flex items-center bg-left bg-cover">
        <div class="container z-10 md:text-right">
            <h1 class="text-red text-6xl lg:text-7xl leading-tight lg:leading-tight font-bold" data-aos="fade-left">
                BEST<br>FITNESS
            </h1>
            <p class="hero__desc my-8 text-lg md:ml-auto text-gray-600" data-aos="fade-left" data-aos-delay="50">
            ...
            <div data-aos="fade-left" data-aos-delay="100">
                <button class="btn px-12" @click="scrollTo">
                    join now
                </button>
            </div>
        </div>
        <div class="absolute inset-0 bg-white bg-opacity-60 lg:hidden" />
    </div>
    ...
    <div id="services" class="grid grid-rows-3 md:grid-rows-2 md:grid-cols-2 lg:grid-rows-1 lg:grid-cols-4 gap-y-12 md:gap-x-7 py-12 md:py-20 lg:py-24 container">
        <FeatureItem
            ...
            :aos-delay="(index + 1) * 100"
        />
    </div>

    <article ref="joinEl" class="apply bg-bottom md:bg-right-bottom bg-no-repeat py-12 md:py-24">
        <div class="container">
            <div class="max-w-lg">
                <div class="border-2 border-red relative p-5 md:p-14" data-aos="fade-right">
                    <div class="uppercase text-red font-bold bg-white absolute -top-3.5 left-12 px-4">
                        only 5 days
                    </div>
                ...
                <JoinForm data-aos="fade-up" data-aos-delay="50" />
            </div>
        </div>
    </article>
    ...
    <article id="gallery" class="gallery py-12 md:py-20 xl:py-28 bg-gray-100">
        <div class="container relative">
            <div class="gallery__decoration absolute" />
            <div class="xl:absolute xl:top-12 xl:right-0 xl:w-96">
                ...
                <p class="text-lg text-gray-700 text-center xl:text-left mt-11">
    ...
    <article class="hero2 relative flex items-center bg-center bg-cover">
        <div class="container z-10">
            <h1 class="text-red text-6xl lg:text-7xl leading-tight lg:leading-tight font-bold" data-aos="fade-right">
                IT'S TIME<br>FOR FITNESS
            </h1>
            <p class="hero__desc my-8 text-lg text-gray-600" data-aos="fade-right">
                Experience the state-of-the-art fitness! Our studio offers qualified coaches, tailor-made workouts, and the best atmosphere.
            </p>
    ...
    <article id="coaches" class="coaches py-12 md:pt-20 xl:pt-28 xl:pb-10">
        <div class="container relative">
            <h1 class="text-3xl xl:text-5xl font-bold mb-12 xl:mb-20 text-center uppercase">
                Our Coaches
            </h1>
            <CoachesSlider :data="coachesSliderData" />
        </div>
    </article>
    ...
    <div class="container border-t border-b border-gray-100 grid grid-rows-4 grid-cols-1 sm:grid-rows-2 sm:grid-cols-2 md:grid-rows-1 md:grid-cols-4">
        <Counter :number="130" title="clients" animation-name="fade-right" />
        <Counter :number="25" title="coaches" animation-name="fade-up" />
        <Counter :number="9" title="awards" animation-name="fade-up" />
        <Counter :number="25" title="groups" animation-name="fade-left" />
    </div>
    ...
    <footer class="pb-8">
        <div class="container flex flex-wrap justify-center items-center text-center sm:text-left">
            ...
            <div class="contact-item w-full sm:w-1/2 md:w-1/3 px-4 flex flex-col items-center sm:items-start">
                <p class="relative mb-6 text-lg font-bold uppercase font-roboto-condensed">
                    address
                    <span class="absolute top-full -left-2 w-4 h-1 bg-gradient-to-r from-yellow-600 to-red" />
                </p>
                <ul>
                    <li class="text-gray-700">
                        8439 Pierce Court
        ...
        <div class="h-px my-10 bg-gray-200" />
        <div class="container flex flex-col md:flex-row items-center md:items-start md:justify-start lg:justify-between">
            ...
            <p class="copyright text-gray-700 text-sm mt-8 md:mt-0 md:ml-14 lg:ml-0 md:mr-24 lg:mr-0">
                © 2021 Profit. All Rights Reserved. Design by Zemez
            </p>
        </div>
    </footer>
